        ...
        <>
          ...
          <section className="rounded-3xl border border-white/10 bg-white/[0.05] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.35)] backdrop-blur-md">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-white/70">
              ...
              <span className="font-semibold text-white">29.9%</span>, which falls in the{" "}
              <span className="font-semibold text-emerald-200">Medium Low</span>{" "}
              risk category. This suggests that the area is not currently classified as
              high risk, but there are still opportunities to improve habitat quality,
              species resilience, and ecological connectivity.
            </p>
            ...
            <div className="mt-6 grid gap-4 lg:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4 ring-1 ring-white/5">
                ...
                <p className="mt-2 text-sm leading-6 text-white/65">
                  The example explanation rule indicates that species suitability is low.
                  This could mean the current land conditions offer limited nesting,
                  feeding, or shelter opportunities for the selected bird species.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4 ring-1 ring-white/5">
                ...
                <p className="mt-2 text-sm leading-6 text-white/65">
                  Several species in the SRI list are associated with trees, shrubs,
                  woodland edges, hedgerows, and structurally diverse farmland.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4 ring-1 ring-white/5">
                ...
                <p className="mt-2 text-sm leading-6 text-white/65">
                  The XAI rule refers to an unprotected area. Nature-positive actions
                  could therefore focus on voluntary farm-level measures and local
            ...
            <div className="mt-6 rounded-2xl border border-emerald-400/20 bg-emerald-500/10 p-5 ring-1 ring-emerald-400/20">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2">
                <div className="rounded-xl bg-black/20 p-4">
                  <p className="font-semibold text-white">Plant native hedgerows</p>
                  <p className="mt-1 text-sm text-white/65">
                    Improve shelter, nesting habitat, and movement corridors for birds
                    and insects.
                  </p>
                </div>

                <div className="rounded-xl bg-black/20 p-4">
                  <p className="font-semibold text-white">Create flower-rich margins</p>
                  <p className="mt-1 text-sm text-white/65">
                    Increase insect availability, which supports species such as
                    redstarts, warblers, pipits, and nightingales.
                  </p>
                </div>

                <div className="rounded-xl bg-black/20 p-4">
                  <p className="font-semibold text-white">Retain mature trees</p>
                  <p className="mt-1 text-sm text-white/65">
                    Support treecreepers, woodpeckers, tits, jays, and other woodland
                    species.
                  </p>
                </div>

                <div className="rounded-xl bg-black/20 p-4">
                  <p className="font-semibold text-white">Reduce pesticide pressure</p>
                  <p className="mt-1 text-sm text-white/65">
                    Help restore insect populations and improve food availability across
                    the site.
                  </p>
                </div>
              </div>
